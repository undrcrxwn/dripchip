...
namespace DripChip.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20230214124853_SetUpRelations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnimalLocationPoint", b =>
                {
                    ...
                    b.HasKey("VisitedLocationsId", "VisitorsId");

                    b.HasIndex("VisitorsId");

                    b.ToTable("AnimalLocationPoint");
                });
            ...
            modelBuilder.Entity("AnimalLocationPoint", b =>
                {
                    b.HasOne("DripChip.Domain.Entities.LocationPoint", null)
                        .WithMany()
